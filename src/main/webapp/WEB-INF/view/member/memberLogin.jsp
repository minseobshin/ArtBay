...
<div id='memberLogin'>
	<div id='memberLogin2'>
		...
		<form name='frm_findId' id='frm_findId' method='post'>
			<h1>아이디 찾기</h1>
			<input type='text' name='irumFind' id='irumFind' class='midLogin' placeholder="이름" required="required">
			<input type='text' name='emailFind' id='emailFind' class='midLogin' placeholder="이메일주소" required="required">
			...
			<input type='button' name='btnGoIdFind' id='btnGoIdFind' class='btnGoLogin' value='아이디찾기(Email을 확인해주세요.)'>
		...
		<form name='frm_findPwd' id='frm_findPwd' method='post'>
			<h1>비밀번호 찾기</h1>
			<input type='text' name='irumFind2' id='irumFind2' class='midLogin' placeholder="이름" required="required">
			<input type='text' name='idFind' id='idFind' class='midLogin' placeholder="아이디" required="required">
